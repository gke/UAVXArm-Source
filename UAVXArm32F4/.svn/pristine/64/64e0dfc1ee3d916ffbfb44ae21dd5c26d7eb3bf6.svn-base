...
// Autodetects interface protocol; returns device signature and protocol
...
extern boolean esc4wayExitRequested;     // flag that exit was requested. Set by esc4wayProcessCmd, used internally by esc4wayProcess

boolean BLHeliSuiteActive;
