...
void oledInit(void) {
	...
	oledDisplayInt32(1, 7, RCNavFrames);
	oledDisplayString(2, 0, "36MHz", 0);
	oledDisplayInt32(2, 7, RC1CaptureFrames);
	oledDisplayString(3, 0, "GPS", 0);
	oledDisplayInt32(3, 7, TrackGPSInvalid);
