...
// Edited by Benik 3 January 2019
...
#define SSD1X06_I2C_ADDRESS (0x3C*2) // 3c some modules can be 0x3D - depends on how module's internal SA0 has been wired
// UNUSED #define SSD1X06_I2CSPEED 800000L    //normally display communicate on 400kHz. From testing it can handle faster clock up to 800kHz. In case of problems try 400000L
// pixels
#define SSD1X06_LCDWIDTH  128
#define SSD1X06_LCDHEIGHT  64
#define SSD1X06_LCDPAGES  8
// UNUSED #define SSD1X06_COLUMNOFFSET 0

// display chars assuming 6x8 font
#define SSD1X06_CHAR_WIDTH 6
#define SSD1X06_CHAR_HEIGHT 8

#define SSD1X06_LCDWIDTHCHARS  (SSD1X06_LCDWIDTH / SSD1X06_CHAR_WIDTH)
#define SSD1X06_LCDHEIGHTCHARS (SSD1X06_LCDHEIGHT / SSD1X06_CHAR_HEIGHT)
